...
Next up is the memory v1 plan, [`docs/v1-memory-plan.md`](docs/v1-memory-plan.md) — agent experience, retrieval quality, memory types (semantic / episodic / procedural), graph RAG, temporal and layered tracking, and decay. It takes precedence over v0 M5/M6, which resume after it. Tracking: [issue #2](https://github.com/pandacover/yumeoi/issues/2).
